...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200  ">
    <div class="mb-1 w-full">
        <div class="mb-4">
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Data Publisher</h1>
        </div>
        ...
        <div class="flex flex-col-reverse md:flex-row justify-start md:justify-between">
            ...
            <div class="items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                <form action="{{ route('admin.publishers.index') }}" class="lg:pr-3" method="GET">
                    <label for="users-search" class="sr-only">Search</label>
                    <div class="relative w-full md:w-64">
                        <input type="text" name="key" id="users-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for publishers">
                    </div>
                </form>
            </div>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td colspan="3" class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">{{ $publisher->name }}</div>
                                            <div class="text-sm font-normal text-gray-500">#{{ $publisher->id }}</div>
                                        </div>
                                    </td>
...
<script>
    $(document).ready(function() {
        ...
        $('#confirm-destroy-btn').click(function() {
            ...
            var url = "{{ route('admin.publishers.index') }}"
            url = url + "?id=" + itemid;
