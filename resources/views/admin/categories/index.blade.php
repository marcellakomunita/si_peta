                            ...
                            @foreach ($categories as $category)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td colspan="2" class="p-4 whitespace-nowrap space-x-2">
                                        ...
                                        <button id="delete-user-btn" data-item={{ $category->id }} type="button" data-modal-toggle="delete-user-modal" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
...
<script>
    $(document).ready(function() {
        ...
        $('#confirm-destroy-btn').click(function() {
            ...
            var url = "{{ route('admin.categories.destroy') }}"
            url = url + "?id=" + itemid;
