            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="grid grid-cols-2 gap-6 col-span-3">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input value="{{ old('isbn', $book->isbn) }}" type="text" name="isbn" id="isbn" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input value="{{ old('judul', $book->judul) }}" type="text" name="judul" id="judul" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="penulis" class="text-sm font-medium text-gray-900 block mb-2">Penulis</label>
                    <input value="{{ old('penulis', $book->penulis) }}" type="text" name="penulis" id="penulis" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="penerbit" class="text-sm font-medium text-gray-900 block mb-2">Penerbit</label>
                    <input value="{{ old('penerbit', $book->penerbit) }}" type="text" name="penerbit" id="penerbit" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="sinopsis" class="text-sm font-medium text-gray-900 block mb-2">Sinopsis</label>
                    <textarea style="white-space: pre-line" rows='12' type="text" name="sinopsis" id="sinopsis" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>{{ old('penerbit', $book->sinopsis) }}</textarea>
                </div>
                <div class="grid grid-cols-2 gap-6 col-span-3">
