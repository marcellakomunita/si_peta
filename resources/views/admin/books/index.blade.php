        ...
        <div class="flex flex-col-reverse md:flex-row justify-start md:justify-between">
            <div class="items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                <form action="{{ route('admin.books.index') }}" class="lg:pr-3" method="GET">
                    ...
                    <div class="mt-1 relative w-full md:w-96">
                        <input type="text" name="key" id="users-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for ebooks">
                    </div>
                </form>
            </div>
            <div class="w-full flex items-center md:justify-end mb-4 md:mb-0">
                <a href="{{ route('admin.books.create') }}" class="w-1/2 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto mr-8">
                    <button type="button" class="flex items-center justify-center">
                        <svg class="-ml-1 mr-2 h-6 w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg>
                        Add Ebook
                    </button>
                </a>
                <a href="{{ route('admin.books.print') }}" class="w-1/2 text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @else
                                <tr class="h-12 text-center">
                                    <td colspan="5">No Ebooks Found</td>
                                </tr>
                        @endif
                    </tbody>
                </table>
