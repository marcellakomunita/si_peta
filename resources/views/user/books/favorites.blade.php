    ...
    <div class="w-full">
        <div class="mb-8 bg-white rounded-md shadow-sm">
            ...
            <div class="p-4 mx-auto">
                <div class="mt-4 grid grid-cols-2 gap-y-10 gap-x-6 sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
                    @for($i=0; $i < 8; $i++)
                    <div class="group relative rounded-t-xl">
                        ...
                        <div class="flex rounded-b-lg px-4 py-3 flex justify-between bg-white">
                            <div>
                            ...
                            <button id="delete-user-btn" data-item='2' type="button" data-modal-toggle="delete-user-modal" class="z-30 text-red-600 font-medium text-sm  items-center ">
