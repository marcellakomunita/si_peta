            ...
            <div class="">
                <div class="mx-auto flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-16 lg:py-6 mt-6 lg:mt-0">
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">Ilana Tan</h2>
                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Spring in London</h1>
                        <div class="flex mb-4">
                        ...
                        <div class="details">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <p><span class="font-bold text-gray-400">ISBN</span><br>1234567891011</p>
                                <p><span class="font-bold text-gray-400">Penerbit</span><br>Gramedia Pustaka Utama</p>
                                <p><span class="font-bold text-gray-400">Jumlah Halaman</span><br>312</p>
                                <p><span class="font-bold text-gray-400">Tanggal Terbit</span><br>31 Oktober 2006</p>
                            </div>
                        </div>
