                ...
                <div class="space-y-6">
                    <form role="form" action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                        <div class="flex justify-between flex-col-reverse md:flex-row">
                            ...
                            <span class="w-full md:w-2/3 mr-12 mt-4 md:mt-0">
                                <!-- Modal body -->
                                ...
                                <!-- Modal footer -->
                                <div class="flex justify-center md:justify-start py-6 border-t mt-4 border-gray-200 rounded-b">
                                    <button type="submit" class="w-full md:w-fit text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Save</button>
                                </div>
                            </span>
                            ...
                            <span class="flex flex-col items-center">
                                ...
                                <label for="user_photo" class="flex align-center items-center justify-center w-fit mx-auto px-4 mt-3 py-2 custom-file shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600">
