    ...
    <div class="px-6 lg:px-20 pt-16 mt-16 pb-4 border-y grid grid-cols-3 gap-8 md:grid-cols-5">
        <div class="col-span-3 md:col-span-2">
            ...
            <div class="flex mt-4 space-x-4 md:mt-0">
                ...
                <a href="https://www.instagram.com/sibooky" class="text-gray-800 hover:text-gray-900">
                ...
                <a href="https://www.twitter.com/sibooky" class="text-gray-800 hover:text-gray-900">
