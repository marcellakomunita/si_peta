...
<footer class="  " id="footer">
    <div class="px-6 md:px-12 lg:px-20 pt-16 mt-16 pb-4 border-y grid grid-cols-3 gap-8 md:grid-cols-5">
        <div class="col-span-3 md:col-span-2">
            <div class="flex items-center">
                <img src="{{ asset('images/sipeta.png') }}" alt="logo" class="h-24 w-24 mb-8 mr-4">
                <img src="{{ asset('images/semarangkota.png') }}" alt="logo" class="h-20 w-20 mb-8">
            </div>
            ...
            <div class="flex mt-4 space-x-4 md:mt-0">
                <a href="https://id-id.facebook.com/dinasarpus.kotasemarang/" class="text-gray-800 hover:text-gray-900">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                    <span class="sr-only">Facebook page</span>
                </a>
                <a href="https://www.instagram.com/dinasarpus_semarang" class="text-gray-800 hover:text-gray-900">
                ...
                <a href="https://www.twitter.com/dinarpus_smg" class="text-gray-800 hover:text-gray-900">
        ...
        <div>
            ...
            <ul class="text-gray-800">
                ...
                <li class="mb-3">
                    <a href="{{ route('user.books.authors') }}" class="">Penulis</a>
                </li>
            </ul>
        </div>
    </div>
